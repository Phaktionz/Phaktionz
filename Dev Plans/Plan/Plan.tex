...
\end{itemize}
%-------Formats--------%
%Formats use \subsubsection{Name (V F.*.*)}
\input{Formats/V1} %Standard
\input{Formats/V2} %Synthesis 
\input{Formats/V3} %Half-Time
\input{Formats/V4} %King's Revival
